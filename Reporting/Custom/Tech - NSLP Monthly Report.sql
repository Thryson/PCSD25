...
-- ==============================================================
-- |SAVE THIS FOR FILE VALIDATION DO NOT INCLUDE IN PRIMARY RUN |
-- ==============================================================

--SELECT cal.schoolID,
--	SUM(CASE WHEN en.startdate < EOMONTH('08/' + '01/' + CONVERT(VARCHAR, @eYear - 1)) THEN 1 ELSE 0 END) AS 'August',
--	SUM(CASE WHEN en.startdate < EOMONTH('09/' + '01/' + CONVERT(VARCHAR, @eYear - 1)) AND (en.enddate IS NULL OR en.endDate > '09/' + '01/' + CONVERT(VARCHAR, @eYear - 1)) THEN 1 ELSE 0 END) AS 'September',
--	SUM(CASE WHEN en.startdate < EOMONTH('10/' + '01/' + CONVERT(VARCHAR, @eYear - 1)) AND (en.enddate IS NULL OR en.endDate > '10/' + '01/' + CONVERT(VARCHAR, @eYear - 1))THEN 1 ELSE 0 END) AS 'October',
--	SUM(CASE WHEN en.startdate < EOMONTH('11/' + '01/' + CONVERT(VARCHAR, @eYear - 1)) AND (en.enddate IS NULL OR en.endDate > '11/' + '01/' + CONVERT(VARCHAR, @eYear - 1))THEN 1 ELSE 0 END) AS 'November',
--	SUM(CASE WHEN en.startdate < EOMONTH('12/' + '01/' + CONVERT(VARCHAR, @eYear - 1)) AND (en.enddate IS NULL OR en.endDate > '12/' + '01/' + CONVERT(VARCHAR, @eYear - 1))THEN 1 ELSE 0 END) AS 'December',
--	SUM(CASE WHEN en.startdate < EOMONTH('01/' + '01/' + CONVERT(VARCHAR, @eYear)) AND (en.enddate IS NULL OR en.endDate > '01/' + '01/' + CONVERT(VARCHAR, @eYear))THEN 1 ELSE 0 END) AS 'January',
--	SUM(CASE WHEN en.startdate < EOMONTH('02/' + '01/' + CONVERT(VARCHAR, @eYear)) AND (en.enddate IS NULL OR en.endDate > '02/' + '01/' + CONVERT(VARCHAR, @eYear))THEN 1 ELSE 0 END) AS 'February',
--	SUM(CASE WHEN en.startdate < EOMONTH('03/' + '01/' + CONVERT(VARCHAR, @eYear)) AND (en.enddate IS NULL OR en.endDate > '03/' + '01/' + CONVERT(VARCHAR, @eYear))THEN 1 ELSE 0 END) AS 'March',
--	SUM(CASE WHEN en.startdate < EOMONTH('04/' + '01/' + CONVERT(VARCHAR, @eYear)) AND (en.enddate IS NULL OR en.endDate > '04/' + '01/' + CONVERT(VARCHAR, @eYear))THEN 1 ELSE 0 END) AS 'April',
--	SUM(CASE WHEN en.startdate < EOMONTH('05/' + '01/' + CONVERT(VARCHAR, @eYear)) AND (en.enddate IS NULL OR en.endDate > '05/' + '01/' + CONVERT(VARCHAR, @eYear))THEN 1 ELSE 0 END) AS 'May'
